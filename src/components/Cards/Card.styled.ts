...
export const DescriptionListIcon = styled.span.attrs<DataAttributes>({
  'data-testid': 'DescriptionListIcon',
})`
  ${descriptionIconReveal}
`;

export const DescriptionCaretIcon = styled.span.attrs<DataAttributes>({
 ...
 */
export const DescriptionToggleButton = styled.button.attrs<DataAttributes>({
 ...
 */
export const DescriptionBody = styled.div.attrs<DataAttributes>({
 ...
 */
export const DescriptionBodyInner = styled.div.attrs<DataAttributes>({
